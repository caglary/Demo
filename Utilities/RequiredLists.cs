...
namespace Utilities
{
...

    {
        ...
        {
            var initiliazeList=new List<string> { "BAHÇEBAŞI", "KARACAÖREN", "GOP", "YEŞİLYURT", "SEKÜCEK", "ÇIKRIK", "ÇERKEZDANİŞMENT", "DAMLALI", "BÜĞET", "ŞEHİTLER", "ÇIRDAK", "KUŞÇU", "KAVUNLUK", "DOĞLACIK", "YAĞMUR", "EKİNLİ", "YENİKÖY", "GÜNDOĞAN", "SİVRİ", "KARAGÖZGÖLLÜALAN", "KARAOLUK", "YÜZÜNCÜYIL" };
